...
/* MUESTRA TODOS LOS REGISTROS DE LA TABLA FLOPANCIMA.ROL */

CREATE PROCEDURE FLOPANICMA.SP_LISTAR_ROLES
AS
	SELECT DESCRIPCION FROM FLOPANICMA.ROL; 
GO

/* MUESTRA TODOS LOS REGISTROS DE LA TABLA FLOPANICMA.FUNCIONALIDAD */

CREATE PROCEDURE FLOPANICMA.SP_LISTAR_FUNCIONALIDADES
AS
	SELECT DESCRIPCION FROM FLOPANICMA.FUNCIONALIDAD; 
GO
...
/* 
   Permite desactivar (eliminacion mediante "baja logica") 
   y activar (vuelve a habilitar) el estado de un rol en el sistema.
*/
