...
(
		...
		ID_PROFESIONAL INT NOT NULL,
		ID_AFILIADO INT NOT NULL,
		ID_CANCELACION INT NULL DEFAULT 0,
		...
		CONSTRAINT FK_PEDIDO_TURNO_CANCELACION FOREIGN KEY (ID_CANCELACION) REFERENCES FLOPANICMA.CANCELACION(ID_CANCELACION)
);
...
BEGIN
	...
	INSERT INTO FLOPANICMA.AFILIADO --MODIFICAR!!!!!!!!!!!! FALTA NUMERO DE CONSULTA REALIZADAS
