...
BEGIN
	...
	-- GROUP BY PACIENTE_DNI,PACIENTE_NOMBRE,PACIENTE_APELLIDO,PACIENTE_DIRECCION,PACIENTE_TELEFONO,PACIENTE_MAIL,
			-- PACIENTE_FECHA_NAC,PLAN_MED_CODIGO,PLAN_MED_DESCRIPCION,PLAN_MED_PRECIO_BONO_CONSULTA,PLAN_MED_PRECIO_BONO_FARMACIA;
	...
	/*INSERT INTO FLOPANICMA.AFILIADOS
	(ID_AFILIADO,PLAN_MEDICO,ID_PERSONA,NRO_CONSULTA)
	SELECT NEXT VALUE FROM FLOPANICMA.AFILIADO_SEQ, ID_PLAN,ID_PERSONA,*/
