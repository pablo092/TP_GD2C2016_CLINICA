...
END;
GO
/*Para probar procedure DROP PROCEDURE FLOPANICMA.MODIFICACION_PLAN_AFILIADO; --> */
/*EXEC FLOPANICMA.SP_MODIFICACION_PLAN_AFILIADO 
@ID_ERROR=1, @DESC_ERROR = 'No se ingresó un nuevo plan médico', @USERNAME_ID=3 , @PLAN_MEDICO_ANTERIOR = 
555558 ,@PLAN_MEDICO_NUEVO =555557, @DETALLE="cambio de plan repentino";
SELECT *
  FROM [GD2C2016].[FLOPANICMA].[MODIFICACION];
SELECT *
  FROM [GD2C2016].[FLOPANICMA].[MODIFICACION] AS mod
  WHERE mod.ID_AFILIADO = 3;*/
...
/*
RETORNA UNA LISTA DE ROLES A PARTIR DE UNA DESCRIPCIÓN DE ROL (LIKE)
IN: @DESCRIPCION_ROL VARCHAR(50)
OUT: ID_ROL, DESCRIPCION, ID_ESTADO
*/
...
/* /*probar baja de afiliado */
EXEC FLOPANICMA.SP_BAJA_AFILIADO 
@ID_ERROR=1, @DESC_ERROR = 'No se ingresó estado para el afiliado', @USERNAME_ID=3, @ACTIVO_ANTERIOR = 1, @ACTIVO_NUEVO = 0;

SELECT *
  FROM [GD2C2016].[FLOPANICMA].[AFILIADO]
  WHERE ID_AFILIADO = 3;
