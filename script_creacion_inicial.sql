...
CREATE SEQUENCE FLOPANICMA.ID_TURNO AS INT START WITH 202164 INCREMENT BY 1;
...
SET @FECHA = GETDATE(); --LA FECHA DE COMPRA Y DE IMPRESION ES LA MISMA. ESPECIFICAR EN LA ESTRATEGIA
